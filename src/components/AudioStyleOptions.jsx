...
const OPTIONS = [
  {
    ...
    description: "Single voice concise learning summary",
  },
  {
    id: "podcast",
    icon: Users,
    label: "Podcast discussion",
    description: "Two hosts discuss and explain key points",
  },
];

export function AudioStyleOptions({ value, onChange, disabled }) {
  return (
